...
class Twitter {
	...
	private $access_token; // twitter
	private $access_token_secret; // twitter
	...
	public function set_public_config() {
		$this->tmhOAuth->config['user_token']  = $this->access_token;
		$this->tmhOAuth->config['user_secret'] = $this->access_token_secret;
	}
	...
	public function getAccessToken($oauth_verifier)
	{
		...
		$this->tmhOAuth->config['user_token']  = $response_access["oauth_token"];
		$this->tmhOAuth->config['user_secret'] = $response_access["oauth_token_secret"];
